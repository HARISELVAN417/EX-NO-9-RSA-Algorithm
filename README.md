...
while (gcd(e, phi) != 1) e++; 
int d = modInv(e, phi); 
char msg[100]; printf("Enter plaintext: \n"); scanf("%s", msg); 
...
<img width="1893" height="964" alt="image" src="https://github.com/user-attachments/assets/8999e7d1-7c2e-45e5-a1e2-7484880c6193" />
